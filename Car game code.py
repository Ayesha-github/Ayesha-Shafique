...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Racing Car Race -- Ayesha Shafique')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Ayesha Shafique", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("shafiqr504@gmail.com", True, self.white)
